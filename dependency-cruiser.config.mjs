...
export default {
  forbidden: [
    ...
    },
    {
      ...
      severity: 'error',
      comment:
        'Application orchestration depends only on domain, pure scheduling/retrieval engines, and their ports.',
      from: { path: '(^|/)packages/application/' },
      to: {
        path: '(^|/)(apps/|packages/(?!application/|domain/|retrieval/|scheduling/))',
      },
    },
    {
