...
- WP-05 — Walking journal slice: next eligible; not yet started.
...
- WP-04 — Local owner authentication. Completion commit: `WP-04: Local owner authentication`.
...
- Integration branch: `main` through verified WP-04 after fast-forward integration.
...
- None blocking WP-05. Deliberately open later decisions remain in Specification §35.3.
...
- Provider identity, WebAuthn, password-reset email, recovery-code regeneration, journal resources, workers, integrations, vector search, and broader product UI remain correctly deferred.
