...
| Local planning proposals   | Local owner                      | None                                                               | Deterministic windows, local busy blocks, canonical plan intent | provider availability remains unknown    | WP-15 complete; no external projection         |
