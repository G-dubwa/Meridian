...
| Local agenda blocks        | Local owner                      | None                                                               | Owner-scoped canonical Meridian data                           | fail closed without external projection  | WP-13A next                                    |
| In-app reminder lifecycle  | Local owner                      | None                                                               | Canonical reminders and occurrences                            | never claims external delivery           | WP-13A next                                    |
