...
| Provider permissions exceed need         | Exact request/response envelopes; opaque Graph token; unexpected response scope metadata fails closed                       | Re-prove WP-11 incremental consent; reject any extra permission.  |
